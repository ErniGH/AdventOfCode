def v(cInicio, cObjetivo):
    ...
    if cInicio == "E":
        ...
        vInicio = ord(cInicio) - ord("a")

    return vObjetivo+1 >= vInicio
...
posicionMapa[E[0]][E[1]] = 0
evaluadoMapa[E[0]][E[1]] = True
porVisitar.append(Nodo(E[0], E[1], 0))
valoresA = []

while len(porVisitar) > 0:
    nodoActual = porVisitar.pop(0)
    posicionMapa[nodoActual.X][nodoActual.Y] = nodoActual.puntuacion
    if mapa[nodoActual.X][nodoActual.Y] == "a":
        valoresA.append(nodoActual.puntuacion)
